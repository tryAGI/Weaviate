...
namespace Weaviate
{
    public partial class AuthzClient
    {
        ...
        private static readonly global::Weaviate.EndPointSecurityRequirement s_CreateRoleSecurityRequirement0 =
        ...
        private static readonly global::Weaviate.EndPointSecurityRequirement[] s_CreateRoleSecurityRequirements =
            new global::Weaviate.EndPointSecurityRequirement[]
        ...
        {
            await CreateRoleAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weaviate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weaviate.AutoSDKHttpResponse> CreateRoleAsResponseAsync(
                ...
                else
                {
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::Weaviate.ErrorResponse? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::Weaviate.ErrorResponse.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
