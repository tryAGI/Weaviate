...
namespace Weaviate
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Weaviate.EndPointSecurityRequirement s_GetOwnInfoSecurityRequirement0 =
        ...
        private static readonly global::Weaviate.EndPointSecurityRequirement[] s_GetOwnInfoSecurityRequirements =
            new global::Weaviate.EndPointSecurityRequirement[]
            {                s_GetOwnInfoSecurityRequirement0,
            };
        ...
        {
            var __response = await GetOwnInfoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weaviate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weaviate.AutoSDKHttpResponse<global::Weaviate.UserInfo>> GetOwnInfoAsResponseAsync(
            global::Weaviate.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
            ...
            var __authorizations = global::Weaviate.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOwnInfoSecurityRequirements,
                operationName: "GetOwnInfoAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weaviate.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetOwnInfoAsync",
                                pathTemplate: "\"/users/own-info\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weaviate.UserInfo.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weaviate.AutoSDKHttpResponse<global::Weaviate.UserInfo>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weaviate.UserInfo.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
