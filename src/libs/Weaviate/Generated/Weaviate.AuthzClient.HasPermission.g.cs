...
namespace Weaviate
{
    public partial class AuthzClient
    {
        ...
        {
            var __response = await HasPermissionAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weaviate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weaviate.AutoSDKHttpResponse<bool>> HasPermissionAsResponseAsync(
            string id,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weaviate.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "HasPermissionAsync",
                                pathTemplate: "$\"/authz/roles/{id}/has-permission\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Weaviate.AutoSDKHttpResponse<bool>(
                                        statusCode: __response.StatusCode,
