...
namespace Weaviate
{
    public partial class SchemaClient
    {
        ...
        partial void PrepareTenantsGetOneRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string className,
            string tenantName,
            bool? consistency);
        partial void ProcessTenantsGetOneResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTenantsGetOneResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weaviate.TenantResponse> TenantsGetOneAsync(
            string className,
            string tenantName,
        ...
        {
            var __response = await TenantsGetOneAsResponseAsync(
                className: className,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weaviate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weaviate.AutoSDKHttpResponse<global::Weaviate.TenantResponse>> TenantsGetOneAsResponseAsync(
            string className,
            string tenantName,
            bool? consistency = default,
            global::Weaviate.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weaviate.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TenantsGetOne",
                                methodName: "TenantsGetOneAsync",
                ...
                else
                {
                    await global::Weaviate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTenantsGetOneResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weaviate.TenantResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weaviate.AutoSDKHttpResponse<global::Weaviate.TenantResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weaviate.TenantResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
