...
namespace Weaviate
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Weaviate.AutoSDKRetryOptions Retry { get; set; } = new global::Weaviate.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Weaviate.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Weaviate.IAutoSDKHook>();
        ...
        public global::Weaviate.AutoSDKClientOptions AddHook(
            global::Weaviate.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Weaviate.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Weaviate.AutoSDKClientOptions UseAuthorizationProvider(
            global::Weaviate.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Weaviate.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Weaviate.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Weaviate.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Weaviate.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Weaviate.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Weaviate.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Weaviate.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Weaviate.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Weaviate.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Weaviate.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Weaviate.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Weaviate.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Weaviate.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Weaviate.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Weaviate.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Weaviate.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Weaviate.AutoSDKClientOptions clientOptions,
            global::Weaviate.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Weaviate.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Weaviate.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Weaviate.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Weaviate.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Weaviate.IAutoSDKHook, global::Weaviate.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Weaviate.AutoSDKHookContext context)
        {
